...
function buildReadPrompt_(words) {
  ...
  return [
    ...
    '"stumbled". Never mark a word "read" unless you can actually hear it said correctly. If',
    'nothing on the recording is a real attempt at the passage, mark every word "skipped" and set',
    '`confidence` under 0.2. Include exactly one entry per word above, in the same order, using the',
    'same `i` index and `w` word text given.',
    '',
